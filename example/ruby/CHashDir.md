...
## delete_crl(crl) [](#method-i-delete_crl)
...
## get_certs(namenil) [](#method-i-get_certs)

## get_crls(namenil) [](#method-i-get_crls)
...
## hash_dir(silentfalse) [](#method-i-hash_dir)
...
## initialize(dirpath) [](#method-i-initialize)

**@return** [CHashDir] a new instance of CHashDir
...
## load_pem_file(filepath) [](#method-i-load_pem_file)
