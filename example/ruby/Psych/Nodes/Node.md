...
The base class for any Node in a YAML parse tree.  This class should never be
instantiated.
...
## end_column[RW] [](#attribute-i-end_column)
The column number where this node ends

## end_line[RW] [](#attribute-i-end_line)
The line number where this node ends

## start_column[RW] [](#attribute-i-start_column)
...
## to_ruby(symbolize_names:false, freeze:false, strict_integer:false) [](#method-i-to_ruby)
...
## yaml(ionil, options{}) [](#method-i-yaml)
