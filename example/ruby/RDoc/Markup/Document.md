...
documents in this class with documents from `other` when the file matches and
adds documents from `other` when the files do not.

The information in `other` is preferred over the receiver

## merged?() [](#method-i-merged?)
...
## table_of_contents() [](#method-i-table_of_contents)
