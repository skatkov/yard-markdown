...
The Gem::List class is currently unused and will be removed in the next major
rubygems version


# Class Methods
## prepend(list , value ) [](#method-c-prepend)
# Attributes
## tail[RW] [](#attribute-i-tail)
...
## initialize(valuenil, tailnil) [](#method-i-initialize)
...
## prepend(value) [](#method-i-prepend)
