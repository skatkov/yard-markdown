...
#Instance Methods
## add_edge_no_circular(graph, origin, destination, requirement) [](#method-i-add_edge_no_circular)
{include:DependencyGraph#add_edge_no_circular}

**@param** [Graph] the graph to perform the action on
...
## add_vertex(graph, name, payload, root) [](#method-i-add_vertex)
{include:DependencyGraph#add_vertex}
...
## delete_edge(graph, origin_name, destination_name, requirement) [](#method-i-delete_edge)
...
## detach_vertex_named(graph, name) [](#method-i-detach_vertex_named)
{include:DependencyGraph#detach_vertex_named}
...
## rewind_to(graph, tag) [](#method-i-rewind_to)
{include:DependencyGraph#rewind_to}
...
## set_payload(graph, name, payload) [](#method-i-set_payload)
{include:DependencyGraph#set_payload}
...
## tag(graph, tag) [](#method-i-tag)
{include:DependencyGraph#tag}
