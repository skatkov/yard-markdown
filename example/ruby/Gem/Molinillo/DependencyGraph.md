...
# Class Methods
## tsort(vertices ) [](#method-c-tsort)
Topologically sorts the given vertices.
**@param** [Enumerable<Vertex>] the vertices to be sorted, which must
all belong to the same graph.

**@return** [Array<Vertex>] The sorted vertices.

# Attributes
## log[RW] [](#attribute-i-log)

**@return** [Log] the op log for this graph

## vertices[RW] [](#attribute-i-vertices)
...
## add_child_vertex(name, payload, parent_names, requirement) [](#method-i-add_child_vertex)
...
**@param** [Object] the requirement that is requiring the child

**@return** [void] 

## add_edge(origin, destination, requirement) [](#method-i-add_edge)
...
**@param** [Object] the requirement that this edge represents

**@return** [Edge] the added edge

## add_vertex(name, payload, rootfalse) [](#method-i-add_vertex)
...
## delete_edge(edge) [](#method-i-delete_edge)
...
## detach_vertex_named(name) [](#method-i-detach_vertex_named)
...
**@return** [DependencyGraph] a new instance of DependencyGraph

## initialize_copy(other) [](#method-i-initialize_copy)
Initializes a copy of a {DependencyGraph}, ensuring that all {#vertices} are
properly copied.
...
## rewind_to(tag) [](#method-i-rewind_to)
Rewinds the graph to the state tagged as `tag`

**@param** [Object] the tag to rewind to

**@return** [Void] 

## root_vertex_named(name) [](#method-i-root_vertex_named)
...
## set_payload(name, payload) [](#method-i-set_payload)
...
**@param** [Object] an opaque tag for the current state of the graph
...
## to_dot(options{}) [](#method-i-to_dot)

**@param** [Hash] options for dot output.
...
## vertex_named(name) [](#method-i-vertex_named)
