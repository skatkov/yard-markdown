...
## add_extra_platforms!(platforms) [](#method-i-add_extra_platforms!)
...
## delete_by_name(name) [](#method-i-delete_by_name)
...
## find_by_name_and_platform(name, platform) [](#method-i-find_by_name_and_platform)
...
## for(dependencies, platforms_or_legacy_check[nil], legacy_platforms[nil], skips:[]) [](#method-i-for)
...
**@return** [SpecSet] a new instance of SpecSet
...
## insecurely_materialized_specs() [](#method-i-insecurely_materialized_specs)
...
## materialize(deps) [](#method-i-materialize)

## materialized_for_all_platforms() [](#method-i-materialized_for_all_platforms)
...
## missing_specs_for(dependencies) [](#method-i-missing_specs_for)
...
## normalize_platforms!(deps, platforms) [](#method-i-normalize_platforms!)
...
## valid?(s) [](#method-i-valid?)

**@return** [Boolean] 

## validate_deps(s) [](#method-i-validate_deps)

## what_required(spec) [](#method-i-what_required)
