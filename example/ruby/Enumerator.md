...
## each_with_index() [](#method-i-each_with_index)
...
## next_values() [](#method-i-next_values)
...
## peek_values() [](#method-i-peek_values)
...
## with_object(memo) [](#method-i-with_object)
Iterates the given block for each element with an arbitrary object, `obj`, and
returns `obj`
