...
## black_height(xroot) [](#method-i-black_height)
...
**@return** [RedBlackTree] a new instance of RedBlackTree
...
## inorder_walk(xroot) [](#method-i-inorder_walk)

## insert(x) [](#method-i-insert)
...
## maximum(xroot) [](#method-i-maximum)
...
## minimum(xroot) [](#method-i-minimum)
...
## predecessor(x) [](#method-i-predecessor)
...
## reverse_inorder_walk(xroot) [](#method-i-reverse_inorder_walk)

## search(key, xroot) [](#method-i-search)
...
## successor(x) [](#method-i-successor)
