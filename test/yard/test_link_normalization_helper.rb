...
class YARD::TestLinkNormalizationHelper < Minitest::Test
  ...
  def test_link_path_helpers_classify_targets_and_compute_relative_paths
    assert_true YARD::Markdown::LinkNormalizationHelper.constant_reference_path?("A")
    assert_true YARD::Markdown::LinkNormalizationHelper.constant_reference_path?("RSpec::Core")
    assert_true YARD::Markdown::LinkNormalizationHelper.constant_reference_path?("::RSpec::Core")
    assert_true YARD::Markdown::LinkNormalizationHelper.constant_reference_path?("RSpec/Core")
    assert_false YARD::Markdown::LinkNormalizationHelper.constant_reference_path?("")
    ...
    assert_true YARD::Markdown::LinkNormalizationHelper.unresolved_identifier_target?("../../memoized")
    assert_true YARD::Markdown::LinkNormalizationHelper.unresolved_identifier_target?(":memoized")
    assert_true YARD::Markdown::LinkNormalizationHelper.unresolved_identifier_target?("1memoized")
    assert_true YARD::Markdown::LinkNormalizationHelper.unresolved_identifier_target?("Memoized")
    assert_false YARD::Markdown::LinkNormalizationHelper.unresolved_identifier_target?("path/to/file")
    assert_false YARD::Markdown::LinkNormalizationHelper.unresolved_identifier_target?("memoized.rb")
